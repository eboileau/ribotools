...
Note* This is similar to create-orf-profiles form the Rp-Bp
      pipeline, except that it starts from the alignment BAM file,
      it is does not create the ORF profiles, and possibly filters
...
def main():
    ...
    parser.add_argument('--filter-non-periodic', help="""Flag: if this flag is passed, 
    ...
    programs = ['create-base-genome-profile',
    ...
    shell_utils.call_if_not_exists(cmd, out_files, in_files=in_files,
                                   ...
                                   call=call, keep_delete_files=keep_delete_files)
